...
const ListRoom = () => {
  ...
  //toggle availabilty of thr room
  ...
  return (
    <div className='p-4'>
      ...
      <p className='text-gray-700 mt-8 font-semibold'>All Rooms</p>
              ...
              <tr key={index}>
                ...
                <td className='py-3 px-4 border-t border-gray-300 text-sm text-center'>
                  <label className='relative inline-flex items-center cursor-pointer'>
                    ...
                    <span className='absolute left-1 top-1 w-5 h-5 bg-white rounded-full transition duration-200 ease-in-out peer-checked:translate-x-5'></span>
                  </label>
                </td>
              </tr>
            ))}
