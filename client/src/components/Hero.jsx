...
const Hero = () => {
    ...
    const onSearch=async (e) => {
        ...
        //callapi tosave recent searched cities
 ...
 <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url(/src/assets/heroImage.png)] bg-no-repeat bg-cover bg-center h-screen'>
    ...
    <p className='max-w-md mt-2 text-sm md:text-base'>Discover top-rated hotels, cozy stays, and luxury resorts tailored to your needs. Book in seconds, travel with confidence, and make your stay unforgettable.</p>
    </div>
